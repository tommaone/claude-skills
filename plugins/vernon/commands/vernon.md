---
description: "Vernon — Socratic requirement enforcer. Intercepts vague tasks and asks targeted questions until requirements are specific enough to hand to Splinter. Usage: /vernon:vernon <task>"
allowed-tools: ["Read"]
---
